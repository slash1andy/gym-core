 ...
 *
 * @package HMA_Core\Tests\Unit\Location
 */

declare( strict_types=1 );

namespace HMA_Core\Tests\Unit\Location;

use Brain\Monkey;
use Brain\Monkey\Functions;
use HMA_Core\Location\Manager;
use HMA_Core\Location\OrderLocation;
...
class OrderLocationTest extends TestCase {
	...
	/**
	 * @testdox META_KEY constant should contain the hma namespace.
	 */
	public function test_meta_key_contains_hma_namespace(): void {
		$this->assertStringContainsString( 'hma', OrderLocation::META_KEY );
	}
}
