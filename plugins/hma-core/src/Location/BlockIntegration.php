...
/**
 * Registers HMA location data with the WooCommerce block checkout integration
 * registry.
 *
 ...
 * JavaScript via getSetting('hma-location', 'key').
 *
...
class BlockIntegration implements IntegrationInterface {
	 ...
	 *   const data = getSetting( 'hma-location_data', {} );
	 *
	 * @since 1.0.0
	 *
