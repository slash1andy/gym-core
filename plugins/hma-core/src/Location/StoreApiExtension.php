...
class StoreApiExtension {
	 ...
	 *
	 * Included under extensions.hma-core in Cart and Checkout responses.
	 *
	 * @since 1.0.0
	 *
	...
	public function get_location_schema(): array {
		return array(
			'slug'  => array(
				'description' => __( 'The active location slug.', 'hma-core' ),
			...
			'label' => array(
				'description' => __( 'The active location display name.', 'hma-core' ),
				'type'        => array( 'string', 'null' ),
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
			),
