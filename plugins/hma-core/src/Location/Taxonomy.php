...
/**
 * Registers the hma_location taxonomy and seeds the default location terms.
 *
...
class Taxonomy {
	...
	/**
	 * Registers the hma_location taxonomy on the product post type.
	 *
	...
	public function register_taxonomy(): void {
		$labels = array(
			'name'                  => _x( 'Locations', 'taxonomy general name', 'hma-core' ),
			'singular_name'         => _x( 'Location', 'taxonomy singular name', 'hma-core' ),
			'search_items'          => __( 'Search locations', 'hma-core' ),
			'all_items'             => __( 'All locations', 'hma-core' ),
			'edit_item'             => __( 'Edit location', 'hma-core' ),
			'update_item'           => __( 'Update location', 'hma-core' ),
			'add_new_item'          => __( 'Add new location', 'hma-core' ),
			'new_item_name'         => __( 'New location name', 'hma-core' ),
			'menu_name'             => __( 'Locations', 'hma-core' ),
			'not_found'             => __( 'No locations found.', 'hma-core' ),
			'no_terms'              => __( 'No locations', 'hma-core' ),
			'items_list'            => __( 'Locations list', 'hma-core' ),
			'items_list_navigation' => __( 'Locations list navigation', 'hma-core' ),
			'back_to_items'         => __( '&larr; Go to locations', 'hma-core' ),
		);
	...
	public static function seed_terms(): void {
		...
		$terms = array(
			self::ROCKFORD => __( 'Rockford', 'hma-core' ),
			self::BELOIT   => __( 'Beloit', 'hma-core' ),
		);
	...
	/**
	 * Checks whether a given slug is a valid HMA location.
	 *
	 * @since 1.0.0
	 *
